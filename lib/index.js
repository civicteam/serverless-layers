  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
        var hasSettingsChanged, hasFoldersChanged, hasDepsChanged, noChanges, currentLayerARN, version, depsBody, depsPath;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 25:
                ...
                noChanges = !hasFoldersChanged && !hasDepsChanged && !hasSettingsChanged; // merge package default options
              ...
              case 34:
                this.plugin.log(chalk.inverse.yellow(' Changes identified! ')); // ENABLED by default
              ...
              case 47:
                ...
                depsPath = this.dependencies.getDepsPath();
                ...
                _context5.next = 52;
                return this.bucketService.putFile(depsPath, depsBody);
